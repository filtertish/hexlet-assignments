...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Address address2 = new Address(null, "Ufa", "Le", "54", null);
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of("country", List.of("can not be null"), "street", List.of("length less than 5"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address(null, "U", "Lenina", null, null);
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("country", List.of("can not be null"), "city", List.of("length less than 3"), "houseNumber", List.of("can not be null"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
